...
{
	$sql_simpan_cek = "SELECT * FROM infojadwal WHERE deskripsi='$deskripsi' AND idtahunajaran = '$tahunajaran'"; 
	...
	{
		$sql_simpan = "INSERT INTO infojadwal SET aktif = 1, deskripsi = '$deskripsi', idtahunajaran = '$tahunajaran'";  
