...
if ($op=="xm8r389xemx23xb2378e23"){	
	OpenDb();
	$sql_hapus_jam="DELETE FROM jam WHERE replid='$replid'";	
...
<td align="left" valign="top">
    ...
    <tr>
		...
		<?
        OpenDb();
        $sql_jam="SELECT replid, jamke, HOUR(jam1) As jammulai, MINUTE(jam1) As menitmulai, HOUR(jam2) As jamakhir, MINUTE(jam2) As menitakhir FROM jam WHERE departemen='$departemen' ORDER BY jamke ASC";
