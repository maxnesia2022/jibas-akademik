...
if (isset($_REQUEST['simpan'])) {	
	...
	if (mysqli_num_rows($result) > 0) {
		...
		if ($jamke_asli==$jamke){		
			$sql_jam_sebelumnya="SELECT replid as replidsebelumnya, jamke as jamkesebelumnya, HOUR(jam2) As jamakhirsebelumnya, MINUTE(jam2) As menitakhirsebelumnya FROM jam WHERE departemen='$departemen' AND jamke<'$jamke' ORDER BY jamke DESC LIMIT 1";
			...
			if ($jum_awal<$jum_sebelumnya){			
				...
				$sql_jam_simpan="INSERT INTO jam SET jamke='$jamke',jam1='$jam1',jam2='$jam2',departemen='$departemen'";
			...
			$sql_jam_sesudahnya="SELECT replid as replidsesudahnya, jamke as jamkesesudahnya, HOUR(jam1) As jamawalsesudahnya, MINUTE(jam1) As menitawalsesudahnya FROM jam WHERE departemen='$departemen' AND jamke>'$jamke' ORDER BY jamke ASC LIMIT 1";
...
OpenDb();
$sql_ambil_jamke_terakhir="SELECT jamke, departemen FROM jam WHERE departemen='$departemen' ORDER BY jamke DESC LIMIT 1";
