...
if (isset($_REQUEST['Simpan'])) {	
	...
	OpenDb();
	$sql_simpan_cek="SELECT * FROM infojadwal WHERE deskripsi='$deskripsi' AND idtahunajaran = '$tahunajaran' AND replid <> '$replid'"; 	
	...
	if (mysqli_num_rows($result_simpan_cek) > 0) {
		...
		$sql_simpan="UPDATE infojadwal SET deskripsi='$deskripsi' WHERE replid = '$replid'";
