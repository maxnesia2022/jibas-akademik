...
if ($op=="simpan"){
	...
	OpenDb();
	$sql_simpan_cek="SELECT * FROM infojadwal WHERE deskripsi='$deskripsi' AND tglmulai='$tglmulaisimpan' AND 	tglakhir='$tglakhirsimpan' AND idtahunajaran = '$tahunajaran'";  
	...
	<?
		...
		$sql_simpan="INSERT INTO infojadwal SET deskripsi='$deskripsi', tglmulai='$tglmulaisimpan', tglakhir='$tglakhirsimpan', idtahunajaran = '$tahunajaran'";  
