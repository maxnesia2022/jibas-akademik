...
<?	if ($tahunajaran <> "" && $departemen <> "") { 
	OpenDb();	
	$sql = "SELECT i.deskripsi, i.aktif, i.replid FROM infojadwal i, tahunajaran t WHERE t.departemen ='$departemen' AND i.idtahunajaran = '$tahunajaran' AND i.idtahunajaran = t.replid ORDER BY $urut $urutan";
