...
OpenDb();
	...
	//$sql_kalender = "SELECT MONTH(t.tglmulai), YEAR(t.tglmulai), MONTH(t.tglakhir), YEAR(t.tglakhir), t.tglakhir FROM kalenderakademik k, tahunajaran t where k.replid=$kalender AND k.idtahunajaran = t.replid";
	$sql_kalender = "SELECT MONTH(t.tglmulai), YEAR(t.tglmulai), MONTH(t.tglakhir), YEAR(t.tglakhir), k.kalender, t.tglmulai, t.tglakhir, k.departemen, k.aktif, k.terlihat FROM kalenderakademik k, tahunajaran t WHERE k.replid='$kalender' AND k.idtahunajaran = t.replid";
