...
<tr>
    ...
    <tr>
   	...
   	<tr>
        ...
        <?	OpenDb();
            $sql_info_jadwal="SELECT i.replid, i.deskripsi, i.aktif FROM infojadwal i, tahunajaran a WHERE i.idtahunajaran = a.replid AND a.departemen = '$departemen' AND i.idtahunajaran = '$tahunajaran' ORDER BY i.aktif DESC";						            
