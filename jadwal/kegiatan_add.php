...
if (isset($_REQUEST['Simpan'])) {
	...
	if (mysqli_num_rows($result) > 0) {
		...
		$sql_simpan="INSERT INTO aktivitaskalender SET idkalender='$kalender', tanggalawal='$tanggalawal', tanggalakhir='$tanggalakhir', kegiatan='$kegiatan', keterangan='$keterangan'";
