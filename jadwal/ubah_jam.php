...
if (isset($_REQUEST['simpan'])) {	
	...
	if (mysqli_num_rows($result) > 0) {
		...
		$jum_sebelumnya=0;
		$jum_sesudahnya=0;
		$sql_jam_sebelumnya="SELECT replid as replidsebelumnya, jamke as jamkesebelumnya, HOUR(jam2) As jamakhirsebelumnya, MINUTE(jam2) As menitakhirsebelumnya FROM jam WHERE departemen='$departemen' AND jamke<'$jamkey' ORDER BY jamke DESC LIMIT 1";
		...
		$sql_jam_sesudahnya="SELECT replid as replidsesudahnya, jamke as jamkesesudahnya, HOUR(jam1) As jamawalsesudahnya, MINUTE(jam1) As menitawalsesudahnya FROM jam WHERE departemen='$departemen' AND jamke>'$jamkey' ORDER BY jamke ASC LIMIT 1";
		...
		if ($jum_awal < $jum_sebelumnya ){
			...
			if ($jum_akhir > $jum_sesudahnya && $jum_sesudahnya != 0){
				...
				//proses simpan data
				$sql_jam_simpan="UPDATE jam SET jamke='$jamkey',jam1='$jam1',jam2='$jam2' WHERE replid = '$replid'";
...
$sql_y="SELECT HOUR(jam1) as jam1y, MINUTE(jam1) as menit1y, HOUR(jam2) as jam2y, MINUTE(jam2) as menit2y, replid as replidy, jamke as jamkey, departemen FROM jam WHERE replid='$replid'";
