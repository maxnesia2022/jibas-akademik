...
<? OpenDb();
    ...
    <tr height="25">    	
        ...
        <td><?=$row[1] ?></td>        
        <td><?
		$sql3 = "SELECT p.nip,p.nama FROM pegawai p WHERE p.nip='$row[4]'";
        ...
        <td align="center"><? 
			$kelasterpilih=$row[0];
		$sql2 = "SELECT COUNT(*) FROM siswa s WHERE s.idkelas='$kelasterpilih' AND s.aktif=1";
