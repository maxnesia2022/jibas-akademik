...
if (isset($_REQUEST['simpan'])) 
{
	...
	$query_cek = "SELECT * FROM pegawai WHERE nip = '$nip'";
	...
	else 
	{
		...
		$query = "INSERT INTO pegawai SET nip='$nip', nama='$nama', gelarawal='$gelarawal', gelarakhir='$gelarakhir', panggilan='$panggilan', 
