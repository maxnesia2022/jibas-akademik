...
<tr height="30" class="header" align="center">
 ...
 <?	
	...
	while ($row_kelas = @mysqli_fetch_row($result_kelas)) {
		$kelas=$row_kelas[0];
		$sql_get_jumsiswa = "SELECT COUNT(*) FROM siswa s WHERE s.idkelas='$kelas' AND s.aktif=1";
