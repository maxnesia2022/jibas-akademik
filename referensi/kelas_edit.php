...
$sql_get_namatingkat = "SELECT tingkat, departemen FROM tingkat WHERE replid = '$tingkat'";
$result_get_namatingkat = QueryDb($sql_get_namatingkat);
$row_get_namatingkat =@mysqli_fetch_array($result_get_namatingkat);
*/
$sql_get_kelas = "SELECT k.kelas, k.kapasitas, k.keterangan, a.tahunajaran, a.departemen, t.tingkat, k.nipwali, k.idtahunajaran, k.idtingkat FROM kelas k, tahunajaran a, tingkat t WHERE k.replid = '$replid' AND k.idtingkat = t.replid AND k.idtahunajaran = a.replid";
...
$sql_get_pegawai = "SELECT * FROM pegawai WHERE nip = '$row_get_kelas[nipwali]'";
