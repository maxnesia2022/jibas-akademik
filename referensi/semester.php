...
<head>
    ...
    <script type="text/javascript">
        function tambah() {
            ...
            window.open('semester_add.php?departemen='+encodeURIComponent(departemen), 'TambahSemester', 'width=500,height=280,resizable=1,scrollbars=1');
        }
        ...
        function tampil() {
            var departemen = document.getElementById('departemen').value;
            window.location.href = "semester.php?departemen="+encodeURIComponent(departemen);
        }
        ...
        function setaktif(replid, aktif) {
            ...
            if (confirm(msg)) 
                window.location.href = "semester.php?op=dw8dxn8w9ms8zs22&replid="+replid+"&newaktif="+newaktif+"&departemen="+encodeURIComponent(departemen);
        }

        function edit(replid) {
            window.open('semester_edit.php?replid='+replid, 'UbahSemester', 'width=500,height=280,resizable=1,scrollbars=1');
        }

        function hapus(replid) {
            var departemen = document.getElementById('departemen').value;
            if (confirm("Apakah anda yakin akan menghapus semester ini?"))
                window.location.href = "semester.php?op=xm8r389xemx23xb2378e23&replid="+replid+"&departemen="+encodeURIComponent(departemen);
        }

        function cetak() {
            var departemen = document.getElementById('departemen').value;
            window.open('semester_cetak.php?departemen='+encodeURIComponent(departemen), 'CetakSemester', 'width=790,height=650,resizable=1,scrollbars=1');
        }
    </script>
</head>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-emerald-100 p-5">
        ...
        <div class="flex justify-between items-center mb-4 border-b border-gray-100 pb-3">
            <h2 class="text-xl font-bold text-emerald-900 flex items-center gap-2">
                <i class="fas fa-clock text-emerald-500"></i> Semester
            </h2>
            <div class="text-sm text-gray-500 hidden sm:block">
                Referensi <i class="fas fa-chevron-right text-xs mx-1"></i> Semester
            </div>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-emerald-50">
                            <tr>        
                                ...
                                <th class="px-4 py-3 text-left text-xs font-bold text-emerald-800 uppercase tracking-wider w-40 text-center">Semester</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-emerald-50 transition duration-150">                    
                                ...
                                <td class="px-4 py-2 text-gray-900 font-bold text-center text-lg"><?=$row['semester']?></td>
            ...
            <?php } else { ?>
                ...
                <div class="flex flex-col items-center justify-center p-16 text-center bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                    ...
                    <p class="text-gray-500 max-w-md mb-6">
                        Tidak ditemukan data semester untuk departemen <strong><?=$departemen?></strong>.
                    </p>
                    <?php if (SI_USER_LEVEL() != $SI_USER_STAFF) { ?>
