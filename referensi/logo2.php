...
if (isset($_REQUEST['simpan']))
{
	...
	$sql = "SELECT * FROM identitas WHERE departemen='$departemen'";
	$result = QueryDb($sql);
	if (@mysqli_num_rows($result) > 0)
	{
		$sql="UPDATE identitas SET foto='$foto_data' WHERE departemen='$departemen'";
		QueryDb($sql);
	} else {
		$sql="INSERT INTO identitas SET foto='$foto_data', departemen='$departemen'";
		QueryDb($sql);
	} 
	?>
		...
		<form name="main" id="main" method="post" enctype="multipart/form-data" action="getfoto2.php">
			...
			<table width="100%" border="0" cellspacing="0">
			  <tr>
				<td align="center">
					<div id="fotoInfo">
					<!--<img src="../library/gambar.php?replid=<?=$replid?>&table=identitas" border="0"/>-->
					</div>
				</td>
			  </tr>
			  <tr>
