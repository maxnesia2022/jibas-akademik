...
$sql_pegawai = "SELECT * FROM pegawai WHERE replid = '$replid'";
...
if (isset($_REQUEST['simpan'])) 
{
	...
	$query_cek = "SELECT * FROM pegawai WHERE nip = '$nip' AND replid <> '$replid'";
	...
	else 
	{
        ...
        if ($gantifoto != "")
        {
            $sql = "INSERT INTO riwayatfoto SET nip = '$nip', foto = '$foto_data', tanggal = NOW()";
...
<tr height="150">
    ...
    <tr>
        ...
        $sql_bagian="SELECT bagian FROM bagianpegawai ORDER BY urutan ASC";
        ...
        <tr>
            ...
            <img src="../library/gambar.php?replid=<?=$replid?>&table=pegawai"  width="100" border="0"/>
            </td>
       	</tr>
        </table>
        </td>
    ...
    <tr>
        ...
        <?
        $query_a="select agama from agama order by urutan asc " ;
    ...
    <tr>
        ...
        <?
        $query_s="select suku from suku order by urutan asc " ;
