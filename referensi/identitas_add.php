...
if (isset($_REQUEST['Simpan'])) {
	OpenDb();
		$sql1="SELECT * FROM identitas WHERE departemen='$departemen'";
		...
		if (mysqli_num_rows($result1) > 0) {
			$sql = "UPDATE identitas SET nama='$nama', situs='$situs', email='$email', alamat1='$alamat1', alamat2='$alamat2', telp1='$tlp1', telp2='$tlp2', telp3='$tlp3', telp4='$tlp4', fax1='$fax1', fax2='$fax2' WHERE departemen = '$departemen'";
		} else {
			$sql = "INSERT INTO identitas SET nama='$nama', situs='$situs', email='$email', alamat1='$alamat1', alamat2='$alamat2', telp1='$tlp1', telp2='$tlp2', telp3='$tlp3', telp4='$tlp4', fax1='$fax1', fax2='$fax2', departemen='$departemen'";
		}
		//echo $sql; exit;
		$result = QueryDb($sql);
		CloseDb();			
