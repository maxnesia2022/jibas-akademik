...
BeginTrans();
$success=0;
$sql_cek ="SELECT nis from siswa  where nis ='$nis'";
...
$sql_kls="INSERT INTO riwayatkelassiswa SET nis='$nis',idkelas=$idkelas,mulai='$kumplit'";
if ($success)
