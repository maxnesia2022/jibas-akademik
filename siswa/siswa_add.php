	...
	<tr>
        ...
        <tr>
            ...
            <select name="sekolah" id="sekolah" onKeyPress="return focusNext('noijasah', event)"
                ...
                <? 
                $sql_sekolah="SELECT sekolah FROM asalsekolah WHERE departemen='$dep_asal' ORDER BY urutan";
    ...
    <tr>
  	...
  	<tr>
    	...
    	<td bgcolor="#DBD8F3">
            ...
            <? 
            $sql_kerja_ayah="SELECT pekerjaan FROM jenispekerjaan ORDER BY pekerjaan ASC";
