...
<table width="303" border="0" cellspacing="0" class="tab" id="table">
  ...
  <?
	...
	<?
    OpenDb();
		$sql_siswa = "SELECT nis,nama,idkelas from siswa WHERE $jenis LIKE '%$cari%' ORDER BY $urutan ASC"; 
    ...
    <td class="header">&nbsp;</td>
		...
		$idkelas=$row_siswa['idkelas'];
				$sql_gabung = "SELECT t.replid,t.departemen,k.replid,k.kelas,k.idtingkat from tingkat t,kelas k WHERE k.replid='$idkelas' AND t.replid=k.idtingkat AND t.departemen = '$departemen'"; 
