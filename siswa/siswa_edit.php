...
<?php
        ...
        $sql = "SELECT replid FROM phsiswa WHERE nis = '$nis' LIMIT 1";
        $res = QueryDb($sql);
        $ndata = mysqli_num_rows($res);

        if ($ndata == 0)
        {
            $sql = "SELECT replid FROM ppsiswa WHERE nis = '$nis' LIMIT 1";
            $res = QueryDb($sql);
            $ndata = mysqli_num_rows($res);
        }
        ...
        if ($ndata == 0)
        {
            $sql = "SELECT replid FROM nilaiujian WHERE nis = '$nis' LIMIT 1";
            $res = QueryDb($sql);
            $ndata = mysqli_num_rows($res);
        }
        ...
        if ($ndata == 0)
        {
            $sql = "SELECT replid FROM besarjtt WHERE nis = '$nis' LIMIT 1";
            $res = QueryDb($sql);
            $ndata = mysqli_num_rows($res);
        }
        ...
        if ($ndata == 0)
        {
            $sql = "SELECT replid FROM penerimaaniuran WHERE nis = '$nis' LIMIT 1";
            $res = QueryDb($sql);
            $ndata = mysqli_num_rows($res);
        }
        ...
        if ($ndata == 0)
        {
            $sql = "SELECT replid FROM pinjam WHERE nis = '$nis' LIMIT 1";
            $res = QueryDb($sql);
            $ndata = mysqli_num_rows($res);
        }
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <select name="agama" id="agama" class="ukuran" onKeyPress="return focusNext('suku', event)"
                    ...
                    <? 
                        $sql_agama="SELECT replid,agama,urutan FROM agama ORDER BY urutan";
        ...
        <tr>
            ...
            <td>
            	...
            	<select name="dep_asal" id="dep_asal"  onKeyPress="return focusNext('sekolah', event)"
					...
					<? 
                    $sql_departemen="SELECT DISTINCT departemen FROM asalsekolah ORDER BY departemen";   
        ...
        <tr>
            ...
            <td bgcolor="#DBD8F3">
                ...
                <select name="pendidikanayah" id="Infopendidikanayah" class="ukuran" onKeyPress="return focusNext('Infopendidikanibu', event)"
                    ...
                    <? 
                    $sql_pend_ayah="SELECT pendidikan FROM tingkatpendidikan ORDER BY pendidikan";
            ...
            <td bgcolor="#E9AFCF">
            	...
            	<tr>
                    ...
                    <select name="pendidikanibu" id="Infopendidikanibu" class="ukuran" onKeyPress="return focusNext('Infopekerjaanayah', event)"
                        ...
                        <option value="">[Pilih Pendidikan]</option>
                        <? 
                        $sql_pend_ibu="SELECT pendidikan FROM tingkatpendidikan ORDER BY pendidikan";
        ...
        <tr>
            ...
            <td bgcolor="#DBD8F3">
                ...
                <select name="pekerjaanayah" id="Infopekerjaanayah" class="ukuran"  onKeyPress="return focusNext('Infopekerjaanibu', event)"
                    ...
                    <? 
                    $sql_kerja_ayah = "SELECT pekerjaan FROM jenispekerjaan ORDER BY pekerjaan";
