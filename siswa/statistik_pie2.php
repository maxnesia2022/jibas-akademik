...
for ($i=1;$i<=$jum;$i++) {	
	...
	if ($departemen<>"-1" && $angkatan>0) {	
		$query1 = "SELECT COUNT(*) As Jum$field FROM siswa s, angkatan a WHERE s.idangkatan='$idproses' AND a.replid=s.idangkatan AND a.departemen='$departemen' AND s.aktif = $filter ";
	}
