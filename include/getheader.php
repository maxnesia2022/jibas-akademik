...
function getHeader($dep){
	...
	$sql = "SELECT replid,nama,alamat1,alamat2,telp1,telp2,telp3,telp4,fax1,fax2,situs,email FROM identitas WHERE departemen='$dep'";
	//return $sql;exit;
	$result = QueryDb($sql); 
	...
	$head .="		<img src=\"".$full_url."library/gambar.php?replid=".$replid."&table=identitas&" . rand(1, 5000) . "\" />";
	$head .="		</td>";
