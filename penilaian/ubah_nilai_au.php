...
if(isset($_POST['ubah'])) {
    ...
    $query_up = "UPDATE nau SET nilaiAU = '$_POST[nilai]' WHERE replid = '$_POST[id]'";
...
$query = "SELECT * FROM nau WHERE replid = '$_GET[id]'";
...
?>
	...
	<table border="0" align="center" width="95%">
        ...
        <tr>
            <td>Nama</td><td>
			<?
			$query_nm = "SELECT * FROM siswa WHERE siswa.nis = '$row[nis]'";
