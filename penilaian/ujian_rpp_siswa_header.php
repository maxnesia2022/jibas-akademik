...
<tr>
    ...
    <tr>
        ...
        <td>
		<?
        $query_s = "SELECT replid, semester, aktif FROM semester ".
	...
	<tr>
		...
		<?	$query_t = 	"SELECT replid, tingkat FROM tingkat ".
        ...
        <?
            $query_k = "SELECT k.replid, k.kelas FROM kelas k, tahunajaran a WHERE k.idtingkat = '$tingkat' AND k.aktif = 1 AND k.idtahunajaran = a.replid AND a.departemen = '$departemen' AND a.aktif = 1";
			//echo $query_k;
        ...
        <td>
        	<select name="pelajaran" id="pelajaran" size="1" style="width:225px;" onChange="change_sel2();">
          	<? 	$query_p = "SELECT replid, nama FROM pelajaran ".
