...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="93%" height="50" bgcolor="#666666"><span class="style5">
	  ...
	  <span class="style1">
	  : <?
	$sql_get_nama="SELECT nama FROM siswa WHERE nis='$nis'";
  ...
  <tr>
	...
	<?
	$sql_get_pelajaran_laporan="SELECT * FROM pelajaran WHERE departemen='$departemen' ORDER BY nama ASC";
	...
	while ($row_get_pelajaran_laporan=@mysqli_fetch_array($result_get_pelajaran_laporan)){
		$sql_get_pred="SELECT k.predikat as predikat FROM komennap k, infonap i WHERE k.nis='$nis' AND i.idpelajaran='$row_get_pelajaran_laporan[replid]' AND i.replid=k.idinfo";
		...
		$sql_get_infonap="SELECT replid,nilaimin FROM infonap WHERE idpelajaran='$row_get_pelajaran_laporan[replid]' AND idsemester='$semester' AND idkelas='$kelas'";
		...
		$sql_get_nap_PK="SELECT n.nilaiangka as nilaiangka,n.nilaihuruf as nilaihuruf FROM nap n, aturannhb a WHERE n.idinfo='$row_get_infonap[replid]' AND n.idaturan=a.replid AND n.nis='$nis' AND a.dasarpenilaian='Pemahaman Konsep'";
		$result_get_nap_PK=QueryDb($sql_get_nap_PK);
		$row_get_nap_PK=@mysqli_fetch_array($result_get_nap_PK);
		//get value from nap praktik
		$sql_get_nap_P="SELECT n.nilaiangka as nilaiangka,n.nilaihuruf as nilaihuruf FROM nap n, aturannhb a WHERE n.idinfo='$row_get_infonap[replid]' AND n.idaturan=a.replid AND n.nis='$nis' AND a.dasarpenilaian='Praktik'";
  ...
  <tr>
	...
	<?
	$sql_get_pelajaran_komentar="SELECT * FROM pelajaran WHERE departemen='$departemen' ORDER BY nama ASC";
	...
	$sql_get_komentar="SELECT k.komentar FROM komennap k, infonap i WHERE k.nis='$nis' AND i.idpelajaran='$row_get_pelajaran_komentar[replid]' AND i.replid=k.idinfo";
  ...
  <!-- Ambil pelajaran per departemen-->
	<?
	$sql_get_pelajaran_presensi="SELECT * FROM pelajaran WHERE departemen='$departemen' ORDER BY nama ASC";
	...
	$sql_get_all_presensi="select count(*) as jumlah FROM presensipelajaran pel, ppsiswa pp ".
	...
	//ambil yang hadir
	$sql_get_hadir="select count(*) as hadir FROM presensipelajaran pel, ppsiswa pp ".
						  "WHERE pel.idpelajaran='$row_get_pelajaran_presensi[replid]' AND pel.idsemester='$semester' AND pel.idkelas='$kelas' ".
	...
	//ambil yang sakit
	$sql_get_sakit="select count(*) as sakit FROM presensipelajaran pel, ppsiswa pp ".
						  "WHERE pel.idpelajaran='$row_get_pelajaran_presensi[replid]' AND pel.idsemester='$semester' AND pel.idkelas='$kelas' ".
	...
	//ambil yang ijin
	$sql_get_ijin="select count(*) as ijin FROM presensipelajaran pel, ppsiswa pp ".
						  "WHERE pel.idpelajaran='$row_get_pelajaran_presensi[replid]' AND pel.idsemester='$semester' AND pel.idkelas='$kelas' ".
	...
	//ambil yang alpa
	$sql_get_alpa="select count(*) as alpa FROM presensipelajaran pel, ppsiswa pp ".
						  "WHERE pel.idpelajaran='$row_get_pelajaran_presensi[replid]' AND pel.idsemester='$semester' AND pel.idkelas='$kelas' ".
	...
	$sql_all_hadir="select count(*) as allhadir FROM presensipelajaran pel, ppsiswa pp ".
	...
	$sql_all_sakit="select count(*) as allsakit FROM presensipelajaran pel, ppsiswa pp ".
	               "WHERE pel.idsemester='22' AND pel.idkelas='$kelas' ". 
                   "AND pel.replid=pp.idpp AND pp.nis='$nis' AND pp.statushadir=1";
	...
	$sql_all_ijin="select count(*) as allijin FROM presensipelajaran pel, ppsiswa pp ".
	               "WHERE pel.idsemester='22' AND pel.idkelas='$kelas' ". 
                   "AND pel.replid=pp.idpp AND pp.nis='$nis' AND pp.statushadir=2";
	...
	$sql_all_alpa="select count(*) as allalpa FROM presensipelajaran pel, ppsiswa pp ".
	               "WHERE pel.idsemester='22' AND pel.idkelas='$kelas' ". 
                   "AND pel.replid=pp.idpp AND pp.nis='$nis' AND pp.statushadir=3";
