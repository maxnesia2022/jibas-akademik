...
$komentar=$_REQUEST['komentar'];
$sql_update="UPDATE komennap SET komentar='$komentar' WHERE replid='$_REQUEST[replid]'";
...
<tr height="150">
    ...
    <!-- CONTENT GOES HERE //--->
<?
$sql_get_comment="SELECT k.komentar,s.nama,k.nis FROM komennap k, siswa s WHERE k.nis=s.nis AND k.replid='$replid'";
