...
<table width="100%" border="0">
	...
	<tr>
		...
		<td>
		<?
		$query_tkt = "SELECT * FROM tingkat WHERE replid = '$tingkat'";
	...
	<tr>
		...
		<td>
		<? 
		$query_kls = "SELECT * FROM kelas WHERE replid = '$kelas'";
	...
	<tr>
		...
		<? if($pelajaran == "all"){
				...
				$query_pel = "SELECT nama FROM pelajaran WHERE replid = '$pelajaran'";
...
<input type="hidden" name="jenis" value="<?=$jenis_penilaian ?>">
	...
	<?	
	$query_jp = "SELECT * FROM jenisujian ".
