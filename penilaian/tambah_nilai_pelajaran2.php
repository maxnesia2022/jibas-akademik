...
if(isset($_POST['simpan'])) {
	$sql_del_nau="DELETE FROM nau WHERE  idpelajaran='$_POST[idpelajaran]' AND idkelas='$_POST[idkelas]' AND idsemester='$_POST[idsemester]' AND idjenis='$_POST[idjenis]'";
	$result_del_nau=QueryDb($sql_del_nau);
	$tanggaldb=unformat_tgl($_POST['tanggal']);
	$query_ujian = "INSERT INTO ujian(idpelajaran, idkelas, idsemester, idjenis, deskripsi, tanggal) ".
	...
	$query_id = "SELECT last_insert_id() FROM ujian";
	$result_id = QueryDb($query_id);
	$row_id = @mysqli_fetch_row($result_id);
	$iduj=$row_id[0];
	
	$sql = "SELECT replid FROM nilaiujian WHERE idujian = '$row_id[0]' GROUP BY nis, nilaiujian";
	$rs = QueryDb($sql);
	...
	while($i < ($_POST['num_data']+1)){
		...
		$query_nuj1 = "SELECT * FROM nilaiujian WHERE nilaiujian.idujian = '$iduj'";
	...
	$query_ruk = "INSERT INTO ratauk (idkelas, idsemester, idujian, nilaiRK, keterangan) ".
...
<tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
			...
			<?
			$query_jp = "SELECT * FROM jenisujian WHERE jenisujian.replid = '$jenis_penilaian'";
        ...
        <tr>
            ...
            <td>
			<?
			$query_thn = "SELECT * FROM tahunajaran WHERE tahunajaran.replid = '$tahun'";
			...
			<td>
			<?
			$query_smt = "SELECT * FROM semester WHERE semester.replid = '$semester'";
        ...
        <tr>
			...
			<td>
			<?
			$query_tkt = "SELECT * FROM tingkat WHERE tingkat.replid = '$tingkat'";
			...
			<td>
			<?
			$query_kls = "SELECT * FROM kelas WHERE kelas.replid = '$kelas'";
        ...
        <tr>
            ...
            <td>
			<?
			$query_pel = "SELECT * FROM pelajaran WHERE pelajaran.replid = '$pelajaran'";
		...
		<tr>
			...
			<?	
				...
				$query_sis = "SELECT siswa.nis, siswa.nama FROM siswa ".
