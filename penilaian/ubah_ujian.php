...
$query = "SELECT u.idrpp, u.deskripsi, u.idsemester, u.idpelajaran, u.tanggal, k.idtingkat, u.kode FROM ujian u, kelas k WHERE u.replid = '$replid' AND u.idkelas = k.replid";
...
if(isset($_REQUEST["ubah"])){
	...
	if ($idrpp == "")
		$sql_simpan="UPDATE ujian SET idrpp=NULL, deskripsi='$deskripsi',tanggal='$tanggal', kode = '$kode' WHERE replid='$replid'";
	else
		$sql_simpan="UPDATE ujian SET idrpp='$idrpp', deskripsi='$deskripsi',tanggal='$tanggal', kode = '$kode' WHERE replid='$replid'";
