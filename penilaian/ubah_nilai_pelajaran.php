...
if (isset($_POST['simpan'])) {
    ...
    $query = "UPDATE ujian SET deskripsi = '".CQ($_POST['deskripsi'])."',tanggal='$_POST[tanggal_baru]' ".
             "WHERE replid = '$_POST[iduj]'";
    } else {
	$tgl=unformat_tgl($_POST['tanggal']);
	$query = "UPDATE ujian SET deskripsi = '".CQ($_POST['deskripsi'])."',tanggal='$tgl' ".
             "WHERE replid = '$_POST[iduj]'";
	}
...
<tr height="150">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="95%" align="center">
		...
		<tr>
			...
			<?
			$query_uj = "SELECT * FROM ujian WHERE replid = '$_GET[id]'";
