...
OpenDb();	
$query = "SELECT s.nama, s.nis, n.nilaiAU FROM nau n , siswa s WHERE n.replid = '$replid' AND n.nis = s.nis";
...
if(isset($_REQUEST["ubah"]))
{
	...
	$sql_simpan = "INSERT INTO auditnilai SET jenisnilai='nau', idnilai='$replid', 
						nasli='$nasli', nubah='$nilai', alasan='$alasan', pengguna='$pengguna', informasi='$info'";
   QueryDb($sql_simpan);
	
	$sql_simpan = "UPDATE nau SET nilaiAU='$nilai', keterangan='Nilai Akhir diubah manual',info1=1 WHERE replid='$replid'";
