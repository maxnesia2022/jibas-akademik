        ...
        foreach($my_data as $ns => $d) {
            ...
            foreach($r_aturan as $id_aturan1){
				...
				$query_nhb = "SELECT bobot ".
							 "FROM aturannhb WHERE aturannhb.replid = '$id_aturan1'";				 
				$result_nhb = QueryDb($query_nhb) or die(mysqli_error());
				...
				$query_nap = "SELECT nap.nilaihuruf, nap.nilaiangka FROM nap WHERE nis = '$ns' ".
			...
			$query_kom = "SELECT predikat FROM komennap WHERE nis='$ns' AND idinfo = '$row_cek[replid]'";
...
if(isset($_POST['simpan'])) {
    ...
    $query_ko = "SELECT komennap.replid FROM komennap, siswa " .
    ...
    $query_n = "SELECT DISTINCT idaturan FROM nap WHERE idinfo = '$_POST[info]'";
