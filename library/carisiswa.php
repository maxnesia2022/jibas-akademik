...
OpenDb();
$sql_kelas="SELECT k.kelas,k.idtahunajaran,k.idtingkat,t.departemen,t.tahunajaran FROM kelas k, tahunajaran t WHERE k.replid='$replid' AND t.replid=k.idtahunajaran";
