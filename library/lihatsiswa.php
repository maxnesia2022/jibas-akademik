...
OpenDb();
$sql_kelas="SELECT k.kelas,k.idtahunajaran,k.idtingkat,t.departemen,t.tahunajaran,k.aktif,i.tingkat FROM kelas k, tahunajaran t, tingkat i WHERE k.replid='$replid' AND t.replid=k.idtahunajaran AND k.idtingkat=i.replid";
...
<? 	OpenDb();
	$sql = "SELECT * FROM siswa WHERE idkelas='$replid' AND aktif=1 ORDER BY nama";
	$result = QueryDB($sql);
	$cnt = 0;
