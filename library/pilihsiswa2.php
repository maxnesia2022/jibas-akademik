  ...
  <fieldset><legend><b>Pilih Siswa Berdasarkan</b></legend>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" >
			  <tr>
				...
				$query_dep = "SELECT departemen FROM departemen ORDER BY urutan ASC";
			...
			$query_thn = "SELECT replid, tahunajaran FROM tahunajaran ".
             ...
             <td><input type="text" name="tahun_ajaran" value="<?=$row_thn[tahunajaran] ?>" readonly size="25">
			  ...
			  <tr>
				...
				<td colspan="2">
					...
					<?
					$query_tkt = "SELECT * FROM tingkat WHERE tingkat.departemen = '$departemen' AND aktif='1'";					
				...
				<?
				$query_kls = "SELECT * FROM kelas WHERE kelas.departemen = '$departemen' ".
...
<?
if ((isset($_POST["cari"]))){
		$selectSQL ="SELECT siswa.nis, siswa.nama FROM siswa ".
