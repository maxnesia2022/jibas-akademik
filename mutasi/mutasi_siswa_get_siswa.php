...
$nama=$_REQUEST['nama'];
if ($nis<>"" && $nama=="")
	$sql="SELECT * FROM siswa WHERE nis LIKE '%$nis%' ORDER BY idkelas,nama";
if ($nama<>"" && $nis=="")
	$sql="SELECT * FROM siswa WHERE nama LIKE '%$nama%' ORDER BY idkelas,nama";
if ($nama<>"" && $nis<>"")
	$sql="SELECT * FROM siswa WHERE nama LIKE '%$nama%', AND nis LIKE '%$nis%' ORDER BY idkelas,nama";	
