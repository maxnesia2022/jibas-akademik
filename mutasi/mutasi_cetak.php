...
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0" >
  <tr>
	...
	$query_mutasi="SELECT s.nis,s.nama,a.angkatan,k.kelas,s.statusmutasi FROM siswa s, angkatan a, kelas k WHERE s.idangkatan=a.replid AND s.aktif=1 AND k.replid=s.idkelas AND a.departemen='$departemen' $tambahan ORDER BY s.nis";
