...
<tr>
    ...
    <tr>
  	...
  	<tr>
        ...
        <?	OpenDb();
			$sql_thn_awal="SELECT DISTINCT YEAR(tglmutasi) as tahunawal FROM mutasisiswa WHERE departemen='$departemen' ORDER BY tahunawal ASC";
        ...
        <?	OpenDb();
			$sql_thn_akhir="SELECT DISTINCT YEAR(tglmutasi) as tahunakhir FROM mutasisiswa WHERE departemen='$departemen' ORDER BY tahunakhir DESC";
