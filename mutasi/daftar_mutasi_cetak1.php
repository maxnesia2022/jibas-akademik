...
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0" >
  ...
  <tr>
	...
	OpenDb();
	if (isset($_REQUEST['tahun'])){	
	$query_mutasi="SELECT s.nis,s.nama,s.statusmutasi,j.jenismutasi,m.tglmutasi,m.keterangan FROM siswa s, jenismutasi j, angkatan a, departemen d, mutasisiswa m WHERE d.departemen='$departemen' AND d.departemen=a.departemen AND a.replid=s.idangkatan AND j.replid=s.statusmutasi AND j.replid=m.jenismutasi AND YEAR(m.tglmutasi)='$tahun' AND s.nis=m.nis ORDER BY j.replid";
	} else {
	$query_mutasi="SELECT s.nis,s.nama,s.statusmutasi,j.jenismutasi,m.tglmutasi,m.keterangan FROM siswa s, jenismutasi j, angkatan a, departemen d, mutasisiswa m WHERE d.departemen='$departemen' AND d.departemen=a.departemen AND a.replid=s.idangkatan AND j.replid=s.statusmutasi AND j.replid=m.jenismutasi AND s.nis=m.nis ORDER BY j.replid";
	}
