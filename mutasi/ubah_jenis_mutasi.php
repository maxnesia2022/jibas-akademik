...
if (isset($_REQUEST['Simpan'])) {
	...
	OpenDb();
	$sql="SELECT * FROM jenismutasi WHERE jenismutasi='$jenismutasi' AND replid <> '$replid'";
	$result=QueryDb($sql);
	...
	if (mysqli_num_rows($result) > 0){
		...
		$sql="UPDATE jenismutasi SET jenismutasi='$jenismutasi',keterangan='$keterangan' WHERE replid='$replid'";
		$result=QueryDb($sql);
		CloseDb();
		if ($result){
	?>
...
OpenDb();
$sql_tampil="SELECT * FROM jenismutasi WHERE replid='$replid'";
