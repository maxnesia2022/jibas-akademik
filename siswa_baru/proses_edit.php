...
if (isset($_REQUEST['simpan'])){
	OpenDb();
	$sql1="SELECT proses from prosespenerimaansiswa where proses='".CQ($_REQUEST['proses'])."' AND departemen='$_REQUEST[departemen]' AND replid <>'$replid'";
	$hasil1=QueryDb($sql1);
	
	$sql2="SELECT proses from prosespenerimaansiswa where kodeawalan='".CQ($_REQUEST['kode'])."' AND departemen='$_REQUEST[departemen]' AND replid <>'$replid'";
	$hasil2 = QueryDb($sql2);
	...
	if (mysqli_fetch_array($hasil1) > 0){
		...
		$sql_update = "UPDATE prosespenerimaansiswa SET proses='".CQ($_REQUEST['proses'])."', kodeawalan='".CQ($_REQUEST['kode'])."', keterangan='".CQ($_REQUEST['keterangan'])."' WHERE replid='$replid'";
...
OpenDb();
$sql_tampil = "SELECT * FROM prosespenerimaansiswa WHERE replid='$replid' ORDER BY proses";
