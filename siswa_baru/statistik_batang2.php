...
if ($departemen=="-1") {
	if ($idproses < 0){
		$query2 = "SELECT proses FROM prosespenerimaansiswa";
	} else {
		$query2 = "SELECT proses FROM prosespenerimaansiswa WHERE replid = '$idproses'";
	}
} else {		
	if ($idproses < 0){
		$query2 = "SELECT proses FROM prosespenerimaansiswa WHERE departemen='$departemen'";
	} else {
		$query2 = "SELECT proses FROM prosespenerimaansiswa WHERE replid = '$idproses' AND departemen='$departemen' ";
	}
}
