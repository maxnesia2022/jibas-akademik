...
/*OpenDb();
$query = "SELECT urutan FROM departemen WHERE departemen = '$departemen'";	
$hasil = QueryDb($query);	
CloseDb();
 	...
 	<tr>
        ...
        <tr>
  		...
  		<tr>
			...
			OpenDb();
			$sql_departemen="SELECT departemen,urutan FROM departemen WHERE departemen <> '$departemen' ORDER BY urutan";			
