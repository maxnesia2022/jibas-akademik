...
<body topmargin="5" leftmargin="5">
	<?
	OpenDb();
	$sql = "SELECT d.departemen,pg.nama FROM guru g, pelajaran p, departemen d,pegawai pg WHERE g.idpelajaran = p.replid AND d.departemen = p.departemen AND g.nip ='$_REQUEST[nip]' AND pg.nip=g.nip GROUP BY d.departemen ORDER BY d.urutan";	
