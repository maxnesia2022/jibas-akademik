...
OpenDb();
$sql = "SELECT g.nip,g.statusguru,g.keterangan,l.departemen,p.nama,g.idpelajaran,l.nama AS pelajar FROM guru g, pelajaran l, pegawai p WHERE g.replid='$replid' AND p.nip = g.nip AND l.replid = g.idpelajaran";
$result = QueryDb($sql);
